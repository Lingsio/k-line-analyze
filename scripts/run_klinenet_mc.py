"""KLineNet-MC Experiment - Multi-channel with edge detection + Mixup"""
...
def create_dataloaders():
    ...
    train_ds = StockDataset(mode='train', augment_prob=CONFIG['augment_prob'], mixup_prob=CONFIG['mixup_prob'], **common)
